...
TD(LSCD), TD(ZABRC),KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,    TD(RSCD),   \
 KC_LCTL, TD(HPRLD),   KC_LALT, KC_LGUI, LSPRSE,  KC_SPC,  KC_SPC,  RSPLWR,  KC_LEFT, KC_DOWN, KC_UP,      KC_RGHT     \
),
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  _______, _______, KC_RALT, _______, _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END   \
),
