...
#define GMLOW MO(_GMLOW)
#define GMHI MO(_GMHI)
...
[_QWERTY] = LAYOUT_preonic_2x2u(
  TD(GRCL),  TFLIP,   SHRUG,   DSPRV,   _______, _______, _______, _______, _______, _______, _______,    TD(BSPTD),  \
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_DEL,//KC_DEL,
...
[_ADJUST] = LAYOUT_preonic_2x2u(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    RESET,   KC_BTN1, KC_MS_U, KC_BTN2, KC_WH_U, _______, _______, _______, _______, _______, KC_NLCK, GAMING,
...
[_HYPER] = LAYOUT_preonic_2x2u(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    MUS1,    UCLEAD,  _______, _______, _______, _______, KC_P7,   KC_P8,   KC_P9,   KC_PAST, KC_PSLS, _______,
    _______, _______, _______, _______, _______, _______, KC_P4,   KC_P5,   KC_P6,   KC_PMNS, _______, _______,
    _______, _______, _______, _______, _______, _______, KC_P1,   KC_P2,   KC_P3,   KC_PPLS, _______, _______,
...
[_SUPER] = LAYOUT_preonic_2x2u(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, TABBK,   TABFW,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______,      _______,         _______,      _______, _______, _______, _______
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  LO  | Alt  |      |    Soace   |    BSpace    |      |      |  HI  |AltGr |
 * `-----------------------------------------------------------------------------------'
 */
[_GAMING] = LAYOUT_preonic_2x2u(
   ...
   KC_LSHIFT,KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSHIFT,
    KC_LCTL, GMLOW,   KC_LALT, XXXXXXX,     KC_SPC,          KC_BSPC,       XXXXXXX, XXXXXXX, GMHI,    OSMAGR
),
...
uint32_t layer_state_set_user(uint32_t state) {
  ...
  state = update_tri_layer_state(state, _GMLOW, _GMHI, _GMADJ);
  return state;
}
