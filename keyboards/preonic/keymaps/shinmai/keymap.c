...
[_GUEST] = LAYOUT_preonic_1x2uC( \
  ...
  KC_LCTL, XXXXXXX, KC_LALT, KC_LGUI, GRSE,          KC_SPC,     KC_RALT, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
...
[_LOWER] = LAYOUT_preonic_1x2uC( \
  ...
  _______, _______, _______, _______, _______,      KC_SPC,    _______,OSM(MOD_RALT),_______, _______, _______  \
),
