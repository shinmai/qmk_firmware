...
[_UCISB] = LAYOUT_planck_2x2u(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,      KC_SPC,         KC_BSPC,       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
),
...
[_ADJUST] = LAYOUT_planck_2x2u(
    RESET,   KC_BTN1, KC_MS_U, KC_BTN2, KC_WH_U, _______, _______, _______, _______, _______, _______, GAMING,
